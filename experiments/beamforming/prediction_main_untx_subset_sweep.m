...
n_samples = 20000; % number of samples used in training
n_test = 50000;
%n_AoA = 5;
%n_AoD = 5;
n_cluster = 20;
...
xlabel('SNR(dB)');ylabel('Prediction error rate');grid on;grid minor;legend('2 Measurement Reported','3 Measurement Reported','4 Measurement Reported','5 Measurement Reported','Full set');title('Prediction error rate comparison');
