...
for i_rx_hypo = 1:n_rxg_hypo
    twosetsy= generate_y_twosets(CDL_x,tx_params_rx_asp,tx_params,rx_params_hypo(i_rx_hypo,:),n_samples,snr_dB_training);
    Y_sample_Rxg(i_rx_hypo,:,:) = twosetsy(1:n_samples,:);
    Y_sample_tx(i_rx_hypo,:,:) = twosetsy(n_samples+1:2*n_samples,:);
